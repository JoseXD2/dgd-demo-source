...
class ClientPrefs {
	...
	public static var barNotes:Bool = false;
	public static var noteHitMovements:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.barNotes = barNotes;
		FlxG.save.data.noteHitMovements = noteHitMovements;
		...
		save.bind('controls', 'demigodDuel'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.noteHitMovements != null) {
			noteHitMovements = FlxG.save.data.noteHitMovements;
		}
		...
		if(FlxG.save.data.barNotes != null) {
			barNotes = FlxG.save.data.barNotes;
		}

		var save:FlxSave = new FlxSave();
		save.bind('controls', 'demigodDuel');
